...
Each method should take data and scale factor, return upsampled data.

Domain-agnostic: works on any 2D numpy array.
"""
...
def register_upsampling(
    ...
    Usage:
        ...
        def upsample_bicubic(data, scale=2):
...
def run_upsampling(
    ...
    """
    Run an upsampling method on 2D data.
    ...
    return method.func(data, **run_params)
